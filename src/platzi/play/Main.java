        ...
        while (true){
            ...
            switch (opcionElegiada){
                case AGREGAR -> {
                    ...
                    Genero genero = Genero.valueOf(ScannersUtils.capturarTexto("Genero del contenido"));
                ...
                case BUSCAR_POR_GENERO -> {
                    Genero generoBuscado = ScannersUtils.capturarGenero("Genero del contenido a buscar:");
